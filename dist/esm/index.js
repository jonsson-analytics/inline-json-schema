...
export function isString(exact) {
...
export function isNumber(exact) {
    var error = function (path) { return ({
        expected: 'number',
        path: path,
...
export function isBoolean(exact) {
    var error = function (path) { return ({
        expected: 'boolean',
        path: path,
...
export var isNull = function (value, path) {
    if (value !== null)
        throw {
            expected: 'null',
            path: path,
...
export var isUndefined = function (value, path) {
    if (value !== undefined)
        throw {
            expected: 'undefined',
            path: path,
...
export function has(key, schema) {
    return function (value, path) {
